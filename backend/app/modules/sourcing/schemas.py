...
class CandidateRead(BaseModel):
    ...
    id:int;name:str;marketplace:str;country:str;source_price:float;target_price:float;shipping_cost:float;platform_fee_rate:float;ad_cost_rate:float;competition_score:float;trend_score:float;brand_score:float;total_cost:float;gross_profit:float;margin_rate:float;total_score:float;recommendation:str;explanation:str;status:str;created_at:datetime;updated_at:datetime
class CandidateStatusUpdate(BaseModel): status:Literal['pending','approved','rejected']
